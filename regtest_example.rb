...
bc = RPC::JSON::Client.new 'http://warrenv:warrenvPASS@45.79.175.63:18444', 1.1
...
#  puts "balance: #{bc.listaccounts}"
#  puts "getnewaddress: #{bc.getnewaddress}"
  puts "received: #{bc.sendtoaddress('msUqRKMCvjEvvYPNgFutKhHRLDoAMp5MzT', 1.0)}"
